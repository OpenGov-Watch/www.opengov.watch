...
Kian (Rank 4)
- The Parity Tip bot is submitting a lot of proposals to the general OpenGov voting track. But those voters have a hard time judging the proposal. The idea is to push those proposals to the Fellowship Sub-Treasury
- Basti: Only Rank 3s can propose tips.
